...
export const settingsValidation = [
  ...
  body('watcher_delete_on_drive').optional().isIn(['true', 'false']),
  body('backup_delete_on_drive').optional().isIn(['true', 'false']),
  body('backup_delete_local').optional().isIn(['true', 'false']),
...
export async function updateSettings(req: AuthRequest, res: Response): Promise<void> {
  ...
  try {
    const allowedKeys = [
      ...
      'watcher_delete_on_drive',
      'backup_delete_on_drive',
      'backup_delete_local',
